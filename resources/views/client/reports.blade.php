    ...
    <div class="container-index" style="background-image: url('/images/beautiful-drop-water.jpg');">
        <div class="row" style="margin-top:0px;">
            <div class="card text-right" style="margin:50px;justify-content: center;">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('client.getReport')}}">
                        @csrf
                        <input type="hidden" name="device" value="{{session('deviceId')}}" />
                        <div class="row">
                            <div class="row container justify-content-center">
                                <div class="col-sm-4 " style="text-align: right;margin:auto;">
                                    <label for="reportType" style="font-size:15px;">نوع گزارش </label>
                                    <select name="reportType" id="reportType" class="form-control" style="font-size: 14px; height: 40px;margin-top:5px;">
                                ...
                                <div class="col-sm-3" style="width:100%;margin:auto;">
                                    <label for="date_input_1" style="font-size:15px;">از تاریخ:</label>
                                    <br>
                                    <div>
                                        <input name="date_input_1" id="date_input_1" style="background-color:#f1f1f1;height:30px;text-align:center;"/><img id="date_btn_2" src="/images/cal.png" style="vertical-align: top;" />
                                ...
                                <div class="col-sm-3" style="width:100%;margin:auto;">
                                    ...
                                    <label for="date_input_2" style="font-size:15px;">تا تاریخ:</label>
                                    <br>
                                    <div>
                                        <input name="date_input_2" id="date_input_2" style="background-color:#f1f1f1;height:30px;text-align:center;" id="date_input_2"/><img id="date_btn_1" src="/images/cal.png" style="vertical-align: top;" />
                                        <script type="text/javascript">
                                            Calendar.setup({
        ...
        <script>
            ...
            xhttp.onreadystatechange = function() {
                if (this.readyState === 4 && this.status === 200)
                    document.getElementById("firstchart").innerHTML = this.responseText;
            };
