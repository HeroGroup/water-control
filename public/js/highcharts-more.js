...
*/
(function(t) {
    "object" === typeof module && module.exports ? (t["default"] = t, module.exports = t) : "function" === typeof define && define.amd ? define("highcharts/highcharts-more", ["highcharts"], function(A) {
        t(A);
        t.Highcharts = A;
        return t
    }) : t("undefined" !== typeof Highcharts ? Highcharts : void 0)
})(function(t) {
    function A(b, a, r, g) { b.hasOwnProperty(a) || (b[a] = g.apply(null, r)) }
    t = t ? t._modules : {};
    A(t, "parts-more/Pane.js", [t["parts/Globals.js"], t["parts/Utilities.js"]], function(b, a) {
        function r(a, e) { this.init(a, e) }
        var g = a.extend,
            m = a.splat,
        ...
        g(r.prototype, {
            ...
            setOptions: function(a) { this.options = w(this.defaultOptions, this.chart.angular ? { background: {} } : void 0, a) },
            render: function() {
                var a = this.options,
                    e = this.options.background,
                    l = this.chart.renderer;
                this.group || (this.group = l.g("pane-group").attr({ zIndex: a.zIndex || 0 }).add());
                this.updateCenter();
                if (e)
                    for (e =
            ...
            renderBackground: function(a, e) {
                ...
                this.chart.styledMode || g(b, { fill: a.backgroundColor, stroke: a.borderColor, "stroke-width": a.borderWidth });
            ...
            updateCenter: function(a) { this.center = (a || this.axis || {}).center = k.getCenter.call(this) },
            update: function(a, e) {
                w(!0,
                    this.options, a);
                ...
                this.render();
                this.chart.axes.forEach(function(a) { a.pane === this && (a.pane = null, a.update({}, e)) }, this)
            }
        });
        b.Pane = r
    });
    A(t, "parts-more/RadialAxis.js", [t["parts/Globals.js"], t["parts/Utilities.js"]], function(b, a) {
        ...
        var n = {
            ...
            createLabelCollector: function() { return !1 },
            setScale: h,
            setCategories: h,
            setTitle: h
        };
        var p = {
            ...
            defaultRadialOptions: { gridLineInterpolation: "circle", gridLineWidth: 1, labels: { align: "right", x: -3, y: -2 }, showLastLabel: !1, title: { x: 4, text: null, rotation: 90 } },
            ...
            getLinePath: function(c, f) {
                ...
                this.isCircular || "undefined" !== typeof f ? (f = this.chart.renderer.symbols.arc(this.left + c[0], this.top + c[1], p, p, { start: this.startAngleRad, end: this.endAngleRad, open: !0, innerR: 0 }), f.xBounds = [this.left + c[0]], f.yBounds = [this.top + c[1] - p]) : (f = this.postTranslate(this.angleRad, p), f = ["M", c[0] + q.plotLeft, c[1] + q.plotTop, "L", f.x, f.y]);
                return f
            },
            setAxisTranslation: function() {
                B.setAxisTranslation.call(this);
                this.center && (this.transA = this.isCircular ? (this.endAngleRad - this.startAngleRad) / (this.max - this.min || 1) : this.center[2] /
                    2 / (this.max - this.min || 1), this.minPixelPadding = this.isXAxis ? this.transA * this.minPointOffset : 0)
            },
            beforeSetTickPositions: function() {
                this.autoConnect = this.isCircular && "undefined" === typeof k(this.userMax, this.options.max) && r(this.endAngleRad - this.startAngleRad) === r(2 * Math.PI);
            ...
            getPosition: function(c, f) { c = this.translate(c); return this.postTranslate(this.isCircular ? c : this.angleRad, k(this.isCircular ? f : 0 > c ? 0 : c, this.center[2] / 2) - this.offset) },
            ...
            getPlotBandPath: function(c, f, q) {
                ...
                if ("polygon" === this.options.gridLineInterpolation) v = this.getPlotLinePath({ value: c }).concat(this.getPlotLinePath({ value: f, reverse: !0 }));
                else {
                    c = Math.max(c, this.min);
                    f = Math.min(f, this.max);
                    e || (v[0] = this.translate(c), v[1] = this.translate(f));
                    v = v.map(function(f) { n.test(f) && (f = w(f, 10) * h / 100); return f });
                    ...
                    v[0] -= a;
                    v[2] -= a;
                    v = this.chart.renderer.symbols.arc(this.left + p[0], this.top + p[1], v[0], v[0], { start: Math.min(c, f), end: Math.max(c, f), innerR: k(v[1], v[0] - v[2]), open: g });
                    e && (e = (f + c) / 2, a = this.left + p[0] + p[2] / 2 * Math.cos(e), v.xBounds = e > -Math.PI / 2 && e < Math.PI / 2 ? [a, this.chart.plotWidth] : [0, a], v.yBounds = [this.top + p[1] + p[2] / 2 * Math.sin(e)], v.yBounds[0] += e > -Math.PI && 0 > e || e > Math.PI ? -10 : 10)
                }
                return v
            },
            getCrosshairPosition: function(c, f, q) {
                ...
                if (this.isCircular) {
                    ...
                    d = c.x;
                    a = c.y
                } else g(p) || (d = c.chartX, a = c.chartY), g(d) && g(a) && (p = this.translate(Math.min(Math.sqrt(Math.pow(d - f, 2) + Math.pow(a - q, 2)), this.len), !0));
                return [p, d || 0, a || 0]
            },
            getPlotLinePath: function(c) {
                ...
                } else a = f.translate(a), !c.isCrosshair &&
                    (0 > a || a > f.height) && d && (a = 0), "circle" === f.options.gridLineInterpolation ? r = f.getLinePath(0, a) : (p[d ? "yAxis" : "xAxis"].forEach(function(c) { c.pane === f.pane && (u = c) }), r = [], n = u.tickPositions, u.autoConnect && (n = n.concat([n[0]])), e && (n = [].concat(n).reverse()), n.forEach(function(f, c) {
                        m = u.getPosition(f, a);
            ...
            getTitlePosition: function() {
                ...
                return {
                    ...
                    y: f.plotTop + c[1] - { high: .5, middle: .25, low: 0 }[q.align] * c[2] +
                        (q.y || 0)
                }
            },
        ...
        e(l, "init", function(c) {
            ...
            if ("colorAxis" === e) this.isRadial = !1;
                ...
                } else a && (m(this, p), this.defaultPolarOptions = (l = this.horiz) ? this.defaultCircularOptions : u("xAxis" === e ? this.defaultOptions : this.defaultYAxisOptions, this.defaultRadialOptions), q && "yAxis" === e && (this.defaultPolarOptions.stackLabels = this.defaultYAxisOptions.stackLabels));
                d || a ? (this.isRadial = !0, b.chart.zoomType = null, this.labelCollector || (this.labelCollector = this.createLabelCollector()), this.labelCollector && f.labelCollectors.push(this.labelCollector)) : this.isRadial = !1;
                c && l &&
                    (c.axis = this);
                this.isCircular = l
            }
        ...
        e(l, "afterInit", function() {
            var c = this.chart,
                ...
                q = this.pane,
                p = q && q.options;
            c.angular && this.isXAxis || !q || !c.angular && !c.polar || (this.angleRad = (f.angle || 0) * Math.PI / 180, this.startAngleRad = (p.startAngle - 90) * Math.PI / 180, this.endAngleRad = (k(p.endAngle, p.startAngle + 360) - 90) * Math.PI / 180, this.offset = f.offset || 0)
        });
        e(l, "autoLabelAlign", function(c) { this.isRadial && (c.align = void 0, c.preventDefault()) });
        ...
        e(d, "afterGetPosition", function(c) { this.axis.getPosition && m(c.pos, this.axis.getPosition(this.pos)) });
        e(d, "afterGetLabelPosition", function(c) {
            var f = this.axis,
                ...
                m = 0,
                r = 0,
                B = null === d.y ? .3 * -p.height : 0;
            if (f.isRadial) {
                var x = f.getPosition(this.pos,
                    f.center[2] / 2 + z(k(d.distance, -25), f.center[2] / 2, -f.center[2] / 2));
                "auto" === d.rotation ? q.attr({ rotation: e }) : null === a && (a = f.chart.renderer.fontMetrics(q.styles && q.styles.fontSize).b - p.height / 2);
                null === n && (f.isCircular ? (p.width > f.len * f.tickInterval / (f.max - f.min) && (h = 0), n = e > h && e < 180 - h ? "left" : e > 180 + h && e < 360 - h ? "right" : "center") : n = "center", q.attr({ align: n }));
                if ("auto" === n && 2 === f.tickPositions.length && f.isCircular) {
                    90 < b && 180 > b ? b = 180 - b : 270 < b && 360 >= b && (b = 540 - b);
                    180 < u && 360 >= u && (u = 360 - u);
                    if (f.pane.options.startAngle ===
                        l || f.pane.options.startAngle === l + 360 || f.pane.options.startAngle === l - 360) g = "start";
                    n = -90 <= l && 90 >= l || -360 <= l && -270 >= l || 270 <= l && 360 >= l ? "start" === g ? "right" : "left" : "start" === g ? "left" : "right";
                    70 < u && 110 > u && (n = "center");
                    15 > b || 180 <= b && 195 > b ? m = .3 * p.height : 15 <= b && 35 >= b ? m = "start" === g ? 0 : .75 * p.height : 195 <= b && 215 >= b ? m = "start" === g ? .75 * p.height : 0 : 35 < b && 90 >= b ? m = "start" === g ? .25 * -p.height : p.height : 215 < b && 270 >= b && (m = "start" === g ? p.height : .25 * -p.height);
                    15 > u ? r = "start" === g ? .15 * -p.height : .15 * p.height : 165 < u && 180 >= u && (r = "start" ===
                        g ? .15 * p.height : .15 * -p.height);
                    q.attr({ align: n });
                    q.translate(r, m + B)
                }
                c.pos.x = x.x + d.x;
        ...
        a(x, "getMarkPath", function(c, f, q, p, d, a, h) {
            var n = this.axis;
            n.isRadial ? (c = n.getPosition(this.pos, n.center[2] / 2 + p), f = ["M", f, q, "L", c.x, c.y]) : f = c.call(this, f, q, p, d, a, h);
            return f
        })
    });
        ...
        a("arearange", "area", { lineWidth: 1, threshold: null, tooltip: { pointFormat: '<span style="color:{series.color}">\u25cf</span> {series.name}: <b>{point.low}</b> - <b>{point.high}</b><br/>' }, trackByArea: !0, dataLabels: { align: null, verticalAlign: null, xLow: 0, xHigh: 0, yLow: 0, yHigh: 0 } }, {
            ...
            translate: function() {
                ...
                a.points.forEach(function(e) {
                    var b = e.high,
                        n = e.plotY;
                    e.isNull ? e.plotY = null : (e.plotLow = n, e.plotHigh = h.translate(d ? a.modifyValue(b, e) : b, 0, 1, 0, 1), d && (e.yBottom = e.plotHigh))
                });
                this.chart.polar && this.points.forEach(function(d) {
                    a.highToXY(d);
            ...
            getGraphPath: function(a) {
                ...
                for (b = a.length; b--;) {
                    var q = a[b];
                    q.isNull || p || c || a[b + 1] && !a[b + 1].isNull || d.push({ plotX: q.plotX, plotY: q.plotY, doCurve: !1 });
                    var F = { polarPlotY: q.polarPlotY, rectPlotX: q.rectPlotX, yBottom: q.yBottom, plotX: w(q.plotHighX, q.plotX), plotY: q.plotHigh, isNull: q.isNull };
                    d.push(F);
                    e.push(F);
                    q.isNull || p || c || a[b - 1] && !a[b - 1].isNull || d.push({ plotX: q.plotX, plotY: q.plotY, doCurve: !1 })
                }
            ...
            drawDataLabels: function() {
                var a = this.points,
                    ...
                    n, p = this.chart.inverted;
                if (m(l))
                    if (1 < l.length) { var c = l[0]; var f = l[1] } else c = l[0], f = { enabled: !1 };
                else c = g({}, l), c.x =
                    l.xHigh, c.y = l.yHigh, f = g({}, l), f.x = l.xLow, f.y = l.yLow;
                if (c.enabled || this._hasPointLabels) {
                    for (d = h; d--;)
                        if (n = a[d]) {
                            ...
                            n.below = q;
                            p ? c.align || (c.align = q ? "right" : "left") : c.verticalAlign || (c.verticalAlign = q ? "top" : "bottom")
                        }
                    this.options.dataLabels = c;
                    e.drawDataLabels && e.drawDataLabels.apply(this, arguments);
                    for (d = h; d--;)
                        if (n = a[d]) n.dataLabelUpper = n.dataLabel, n.dataLabel =
                            b[d], delete n.dataLabels, n.y = n.low, n.plotY = n._plotY
                }
                if (f.enabled || this._hasPointLabels) {
                    for (d = h; d--;)
                        if (n = a[d]) q = f.inside ? n.plotHigh < n.plotLow : n.plotHigh > n.plotLow, n.below = !q, p ? f.align || (f.align = q ? "left" : "right") : f.verticalAlign || (f.verticalAlign = q ? "bottom" : "top");
                    this.options.dataLabels = f;
                    e.drawDataLabels && e.drawDataLabels.apply(this, arguments)
                }
                if (c.enabled)
                    for (d = h; d--;)
                        if (n = a[d]) n.dataLabels = [n.dataLabelUpper, n.dataLabel].filter(function(f) { return !!f });
            ...
            drawPoints: function() {
                ...
                for (h = 0; h < a;) {
                    var d = this.points[h];
                    d.origProps = { plotY: d.plotY, plotX: d.plotX, isInside: d.isInside, negative: d.negative, zone: d.zone, y: d.y };
                    ...
                    this.chart.polar || (d.isInside = d.isTopInside = "undefined" !== typeof d.plotY &&
                        0 <= d.plotY && d.plotY <= this.yAxis.len && 0 <= d.plotX && d.plotX <= this.xAxis.len);
                    h++
                }
                e.drawPoints.apply(this, arguments);
                for (h = 0; h < a;) d = this.points[h], d.upperGraphic = d.graphic, d.graphic = d.lowerGraphic, g(d, d.origProps), delete d.origProps, h++
            },
            ...
            setState: function() {
                ...
                e.stateMarkerGraphic && (e.lowerStateMarkerGraphic =
                    e.stateMarkerGraphic, e.stateMarkerGraphic = e.upperStateMarkerGraphic);
                ...
                e.stateMarkerGraphic && (e.upperStateMarkerGraphic = e.stateMarkerGraphic, e.stateMarkerGraphic = e.lowerStateMarkerGraphic, e.lowerStateMarkerGraphic = void 0);
                l.setState.apply(this, arguments)
            },
            haloPath: function() {
            ...
            destroyElements: function() {
                ["lowerGraphic", "upperGraphic"].forEach(function(a) { this[a] && (this[a] = this[a].destroy()) }, this);
                this.graphic = null;
                return l.destroyElements.apply(this, arguments)
            },
            isValid: function() { return k(this.low) && k(this.high) }
        });
        ""
    });
    ...
    A(t, "parts-more/ColumnRangeSeries.js", [t["parts/Globals.js"], t["parts/Utilities.js"]], function(b, a) {
        ...
        w("columnrange", "arearange", m(a.column, a.arearange, { pointRange: null, marker: null, states: { hover: { halo: !1 } } }), {
            translate: function() {
                var a =
                    this,
                    l = a.yAxis,
                ...
                a.points.forEach(function(c) {
                    ...
                    k ? (d = c.barX + h, c.shapeType = "path", c.shapeArgs = { d: a.polarArc(e + C, e, d, d + c.pointWidth) }) : (f.height = C, f.y = e, c.tooltipPos = m.inverted ? [l.len + l.pos - m.plotLeft - e - C / 2, b.len + b.pos - m.plotTop - f.x - f.width / 2, C] : [b.left - m.plotLeft + f.x + f.width / 2, l.pos - m.plotTop + e + C / 2, C])
                })
            },
            directTouch: !0,
            ...
            drawGraph: k,
            getSymbol: k,
            crispCol: function() { return z.crispCol.apply(this, arguments) },
            drawPoints: function() { return z.drawPoints.apply(this, arguments) },
            drawTracker: function() { return z.drawTracker.apply(this, arguments) },
            getColumnMetrics: function() { return z.getColumnMetrics.apply(this, arguments) },
            pointAttribs: function() {
                return z.pointAttribs.apply(this,
                    arguments)
            },
            animate: function() { return z.animate.apply(this, arguments) },
            polarArc: function() { return z.polarArc.apply(this, arguments) },
            translate3dPoints: function() { return z.translate3dPoints.apply(this, arguments) },
            translate3dShapes: function() { return z.translate3dShapes.apply(this, arguments) }
        ...
        a("columnpyramid", "column", {}, {
            translate: function() {
                ...
                a.points.forEach(function(c) {
                    ...
                    c.barX = q;
                    c.pointWidth = x;
                    c.tooltipPos = b.inverted ? [l.len + l.pos - b.plotLeft - e, a.xAxis.len - q - C, f] : [q + C, e + l.pos - b.plotTop, f];
                    e = u + (c.total || c.y);
                    ...
                    var y = E + f;
                    0 > c.y && (B = E, y = E + f + d);
                    b.inverted && (w = b.plotWidth - E, v = e - (b.plotWidth - h), m = C * (e - w) / v, k = C * (e - (w - f)) / v, v = q +
                        C + m, m = v - 2 * m, w = q - k + C, k = q + k + C, B = E, y = E + f - d, 0 > c.y && (y = E + f + d));
                    c.shapeType = "path";
                    c.shapeArgs = { x: v, y: B, width: m - v, height: f, d: ["M", v, B, "L", m, B, w, y, k, y, "Z"] }
                })
            }
        });
        ""
    ...
    A(t, "parts-more/GaugeSeries.js", [t["parts/Globals.js"], t["parts/Utilities.js"]], function(b, a) {
        ...
        a("gauge", "line", {
            dataLabels: { borderColor: "#cccccc", borderRadius: 3, borderWidth: 1, crop: !1, defer: !1, enabled: !0, verticalAlign: "top", y: 15, zIndex: 2 },
            dial: {},
            pivot: {},
            ...
            translate: function() {
                ...
                this.points.forEach(function(d) {
                    var b = w(e.dial, d.dial),
                        ...
                        f = b.topWidth || 1,
                        q = e.overshoot,
                        F = a.startAngleRad + a.translate(d.y, null,
                            null, null, !0);
                    if (g(q) || !1 === e.wrap) q = g(q) ? q / 180 * Math.PI : 0, F = r(F, a.startAngleRad - q, a.endAngleRad + q);
                    F = 180 * F / Math.PI;
                    d.shapeType = "path";
                    d.shapeArgs = { d: b.path || ["M", -p, -c / 2, "L", n, -c / 2, l, -f / 2, l, f / 2, n, c / 2, -p, c / 2, "z"], translateX: h[0], translateY: h[1], rotation: F };
                    d.plotX = h[0];
                    d.plotY = h[1]
                })
            },
            drawPoints: function() {
                ...
                a.points.forEach(function(p) {
                    var c = p.graphic,
                        ...
                        q = f.d,
                        d = w(b.dial, p.dial);
                    c ? (c.animate(f), f.d = q) : p.graphic =
                        n[p.shapeType](f).attr({ rotation: f.rotation, zIndex: 1 }).addClass("highcharts-dial").add(a.group);
                    if (!e.styledMode) p.graphic[c ? "animate" : "attr"]({ stroke: d.borderColor || "none", "stroke-width": d.borderWidth || 0, fill: d.backgroundColor || "#000000" })
                });
            ...
            animate: function(a) {
                ...
                a || (e.points.forEach(function(a) {
                    var d = a.graphic;
                    d && (d.attr({ rotation: 180 * e.yAxis.startAngleRad / Math.PI }), d.animate({ rotation: a.shapeArgs.rotation }, e.options.animation))
                }), e.animate = null)
            },
            render: function() {
    ...
    A(t, "parts-more/BoxPlotSeries.js", [t["parts/Globals.js"], t["parts/Utilities.js"]], function(b, a) {
        ...
        g("boxplot", "column", {
            ...
            pointValKey: "high",
            pointAttribs: function() { return {} },
            drawDataLabels: a,
            translate: function() {
                var a = this.yAxis,
                    b = this.pointArrayMap;
                m.column.prototype.translate.apply(this);
                this.points.forEach(function(g) { b.forEach(function(e) { null !== g[e] && (g[e + "Plot"] = a.translate(g[e], 0, 1, 0, 1)) }) })
            },
            drawPoints: function() {
                var a =
                    this,
                    ...
                    e = g.renderer,
                    l, m, h, d, B, x, n = 0,
                    p, c, f, q, F = !1 !== a.doQuartiles,
                    C, E = a.options.whiskerLength;
                a.points.forEach(function(v) {
                    var G = v.graphic,
                        ...
                        J = {},
                        t = v.color || a.color;
                    "undefined" !== typeof v.plotY && (p = w.width, c = Math.floor(w.x), f = c + p, q = Math.round(p / 2), l = Math.floor(F ? v.q1Plot : v.lowPlot), m = Math.floor(F ? v.q3Plot : v.lowPlot), h = Math.floor(v.highPlot), d = Math.floor(v.lowPlot), G || (v.graphic = G = e.g("point").add(a.group), v.stem = e.path().addClass("highcharts-boxplot-stem").add(G),
    ...
    A(t, "parts-more/ErrorBarSeries.js", [t["parts/Globals.js"]], function(b) {
        ...
        r("errorbar", "boxplot", {
            ...
            drawDataLabels: g.arearange ? function() {
                ...
                this.data.forEach(function(b) { b.y = b[a] })
            } : a,
            getColumnMetrics: function() { return this.linkedParent && this.linkedParent.columnMetrics || g.column.prototype.getColumnMetrics.call(this) }
        });
        ""
    });
    A(t, "parts-more/WaterfallSeries.js", [t["parts/Globals.js"], t["parts/Utilities.js"]],
        function(b, a) {
            ...
            var e = b.Axis,
                ...
                B = b.seriesType,
                x = b.seriesTypes;
            a(e, "afterInit", function() { this.isXAxis || (this.waterfallStacks = { changed: !1 }) });
            ...
            B("waterfall", "column", { dataLabels: { inside: !0 }, lineWidth: 1, lineColor: "#333333", dashStyle: "Dot", borderColor: "#333333", states: { hover: { lineWidthPlus: 0 } } }, {
                ...
                generatePoints: function() {
                    ...
                    var p = 0;
                    for (a = this.points.length; p < a; p++) { var c = this.points[p]; var f = this.processedYData[p]; if (c.isIntermediateSum || c.isSum) c.y = m(f) }
                },
                translate: function() {
                    var a = this.options,
                        p = this.yAxis,
                        c, f = t(a.minPointLength, 5),
                        q = f / 2,
                        e = a.threshold,
                        d = a.stacking,
                    ...
                    for (a = g.length; l < a; l++) {
                        ...
                        if (d) {
                            if (b) {
                                ...
                                } else 0 <= u ? (w = k.threshold + k.posTotal, k.posTotal -= u) : (w = k.threshold + k.negTotal,
                                    k.negTotal -= u, w -= u), !k.posTotal && Object.hasOwnProperty.call(k, "absolutePos") && (k.posTotal = k.absolutePos, delete k.absolutePos), !k.negTotal && Object.hasOwnProperty.call(k, "absoluteNeg") && (k.negTotal = k.absoluteNeg, delete k.absoluteNeg);
                        ...
                        y.height = Math.max(Math.round(y.height), .001);
                        m.yBottom = y.y + y.height;
                        y.height <= f && !m.isNull ? (y.height = f, y.y -= q, m.plotY = y.y, m.minPointLengthOffset = 0 > m.y ? -q : q) : (m.isNull && (y.width = 0), m.minPointLengthOffset = 0);
                ...
                processData: function(a) {
                    ...
                    for (l =
                        ...
                        var r = c[l];
                        var k = f && f[l] ? f[l] : {};
                        "sum" === r || k.isSum ? c[l] = m(b) : "intermediateSum" === r || k.isIntermediateSum ? (c[l] = m(d), d = 0) : (b += r, d += r);
                        n = Math.min(b, n);
                        g = Math.max(b, g)
                    }
                ...
                toYData: function(a) { return a.isSum ? "sum" : a.isIntermediateSum ? "intermediateSum" : a.y },
                updateParallelArrays: function(a, p) {
                    h.prototype.updateParallelArrays.call(this, a, p);
                    if ("sum" === this.yData[0] || "intermediateSum" === this.yData[0]) this.yData[0] =
                        null
                },
                ...
                getGraphPath: function() { return ["M", 0, 0] },
                getCrispPath: function() {
                    ...
                    for (l = 1; l < c; l++) {
                        ...
                        if (k) {
                            k = k[l - 1];
                            b ? (k = k.connectorThreshold, u = Math.round(p.translate(k, 0, 1, 0, 1) + (d ? u : 0)) - f) : u = r.y + m.minPointLengthOffset + q - f;
                ...
                setStackedPoints: function() {
                    ...
                    if (this.visible || !this.chart.options.chart.ignoreHiddenSeries) {
                        ...
                        for (var u = 0; u < h; u++) {
                            ...
                            t && t.isIntermediateSum ? (a(m, g, 0, m), m = g, g = f, q ^= e, e ^= q, q ^= e) : t && t.isSum ? (a(f, r, A), q = f) : (a(q, B, 0, r), t && (r += B, g += B));
                            x.stateIndex++;
                            x.threshold = q;
                            q += x.stackTotal
                        }
                ...
                getExtremes: function() {
                    ...
                    if (a) {
                        ...
                        "overlap" === a ? w(e[this.stackKey], function(a) {
    ...
    A(t, "parts-more/PolygonSeries.js", [t["parts/Globals.js"]], function(b) {
        var a = b.Series,
            r = b.seriesType,
            g = b.seriesTypes;
        r("polygon", "scatter", { marker: { enabled: !1, states: { hover: { enabled: !1 } } }, stickyTracking: !1, tooltip: { followPointer: !0, pointFormat: "" }, trackByArea: !0 }, {
            type: "polygon",
            getGraphPath: function() { for (var b = a.prototype.getGraphPath.call(this), g = b.length + 1; g--;)(g === b.length || "M" === b[g]) && 0 < g && b.splice(g, 0, "z"); return this.areaPath = b },
            drawGraph: function() {
    ...
    A(t, "parts-more/BubbleLegend.js", [t["parts/Globals.js"], t["parts/Utilities.js"]], function(b, a) {
        ...
        b.BubbleLegend = function(a, c) { this.init(a, c) };
        b.BubbleLegend.prototype = {
            ...
            drawLegendSymbol: function(a) {
                ...
                e && e.length && m(e[0].value) ? (x(e, function(f, a) { return a.value - f.value }), this.ranges = e, this.setOptions(), this.render(), c = this.getMaxLabelSize(), e = this.ranges[0].radius,
            ...
            setOptions: function() {
                ...
                a.forEach(function(q,
                    p) {
                    m || (b.stroke = w(q.borderColor, c.borderColor, f.color), b.fill = w(q.color, c.color, 1 !== n ? h(f.color).setOpacity(n).get("rgba") : f.color), l.stroke = w(q.connectorColor, c.connectorColor, f.color));
            ...
            getRangeRadius: function(a) { var c = this.options; return this.chart.series[this.options.seriesIndex].getRadius.call(this, c.ranges[c.ranges.length - 1].value, c.ranges[0].value, c.minSize, c.maxSize, a) },
            render: function() {
                ...
                this.ranges.forEach(function(f) { f.value >= c && this.renderRange(f) }, this);
            ...
            renderRange: function(a) {
                ...
                d.bubbleItems.push(e.circle(m, b + ((r % 1 ? 1 : .5) - (f % 2 ? 0 : .5)), h).attr(k ? {} : a.bubbleStyle).addClass((k ? "highcharts-color-" + this.options.seriesIndex + " " : "") + "highcharts-bubble-legend-symbol " + (c.className || "")).add(this.legendSymbol));
                d.connectors.push(e.path(e.crispLine(["M", m, r, "L", m + l, r], c.connectorWidth)).attr(k ? {} : a.connectorStyle).addClass((k ? "highcharts-color-" + this.options.seriesIndex + " " : "") + "highcharts-bubble-legend-connectors " + (c.connectorClassName || "")).add(this.legendSymbol));
                a = e.text(this.formatLabel(a), u, n + g).attr(k ? {} : a.labelStyle).addClass("highcharts-bubble-legend-labels " + (c.labels.className || "")).add(this.legendSymbol);
                p.push(a);
                a.placed = !0;
            ...
            hideOverlappingLabels: function() {
                var a = this.chart,
                    c = this.symbols;
                !this.options.labels.allowOverlap && c && (a.hideOverlappingLabels(c.labels), c.labels.forEach(function(f, a) { f.newOpacity ? f.newOpacity !== f.oldOpacity && c.connectors[a].show() : c.connectors[a].hide() }))
            },
            getRanges: function() {
                var a =
                    ...
                    b = -Number.MAX_VALUE;
                a.chart.series.forEach(function(a) { a.isBubble && !a.ignoreSeries && (f = a.zData.filter(m), f.length && (e = w(a.options.zMin, Math.min(e, Math.max(g(f), !1 === a.options.displayNegative ? a.options.zThreshold : -Number.MAX_VALUE))), b = w(a.options.zMax, Math.max(b, r(f))))) });
                var h = e === b ? [{ value: b }] : [{ value: e }, { value: (e + b) / 2 }, { value: b, autoRanges: !0 }];
                c.length && c[0].radius && h.reverse();
                h.forEach(function(a, f) { c && c[f] && (h[f] = d(!1, c[f], a)) });
                return h
            },
            predictBubbleSizes: function() {
                ...
                else if (l = parseFloat(l), c = (g + d - c.h / 2) * l / 100 / (l / 100 + 1), e && h - c >= b || !e && b - c >= h) c = n;
        ...
        e.prototype.getLinesHeights = function() {
            var a = this.allItems,
                ...
                e, d = 0;
            for (e = 0; e < f; e++)
                if (a[e].legendItemHeight && (a[e].itemHeight = a[e].legendItemHeight), a[e] === a[f - 1] || a[e + 1] && a[e]._legendItemPos[1] !==
        ...
        e.prototype.retranslateItems = function(a) {
            var c, f, e, d = this.options.rtl,
                b = 0;
            this.allItems.forEach(function(q, h) {
                c = q.legendGroup.translateX;
                f = q._legendItemPos[1];
                if ((e = q.movementX) || d && q.ranges) e = d ? c - q.options.maxSize / 2 : c + e, q.legendGroup.attr({ translateX: e });
                h > a[b].step && b++;
        ...
        u(t, "legendItemClick", function() {
            var a = this.chart,
                c = this.visible,
                f = this.chart.legend;
            f && f.bubbleLegend && (this.visible = !c, this.ignoreSeries = c, a = 0 <= a.getVisibleBubbleSeriesIndex(), f.bubbleLegend.visible !== a && (f.update({ bubbleLegend: { enabled: a } }), f.bubbleLegend.visible = a), this.visible = c)
        });
